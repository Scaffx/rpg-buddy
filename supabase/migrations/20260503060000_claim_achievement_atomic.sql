...
-- Substitui o caminho client-side que permitia race condition
-- ============================================================
...
BEGIN
  ...
  -- Lock da linha do user_achievement
  ...
  FROM public.achievements a WHERE a.id = v_ach_id;

  -- Marca resgatada ANTES de conceder (idempotência)
